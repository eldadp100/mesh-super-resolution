...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--ninput_edges', type=int, default=1494, help='# of input edges (will include dummy edges)')
        ...
        self.parser.add_argument('--pool_res', nargs='+', default=[400, 350], type=int, help='pooling res')
        ...
        self.parser.add_argument('--num_groups', type=int, default=1, help='# of groups for groupnorm')
